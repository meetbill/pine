var services = angular.module('pine.services', []);
// 模块服务
// 确定模块名，网页 title ，初始化/设置/获取/当前 section
services.factory('Module', ['$rootScope', '$location', function($scope, $location) {
	var Module = {}
...
// 超时服务
services.factory('Timeout', ['$rootScope', '$timeout', function($scope, $timeout) {
...
services.factory('Message', ['$rootScope', '$timeout', function($scope, $timeout) {
	var Message = {};
...
services.factory('Request', ['$http', '$rootScope', '$location', '$timeout', 'Message', function($http, $scope, $location, $timeout, Message) {
	var Request = {};
